...
public cotizacionVO_1() {
}

    public cotizacionVO_1(int id, int item, int id_cot_cliente, int cot_id_usuario, int dc_id_producto, int cantidad, int fecha, int estado, double precio, double total, double subtotal, String cotestado, String nombreproductoL, String cliente, String usuario) {
        this.id = id;
        this.item = item;
    ...
    public cotizacionVO_1(String string, String string0, String string1, String string2, String string3, String string4, String string5, String string6) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public cotizacionVO_1(String string, String string0, String string1, String string2, String string3, String string4) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public cotizacionVO_1(String string) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public cotizacionVO_1(String cotizacion, String cliente, String usuario, String fecha, double total, String estado) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public cotizacionVO_1(int columna1, String columna2, String columna3, Timestamp columna4, double columna5, String columna6) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
